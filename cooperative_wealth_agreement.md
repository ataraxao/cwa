...
## ARTICLE I — PARTIES; EXECUTION DATE; PURPOSE; INTENT; SCOPE

### 1.1 Parties; Execution Date
This Cooperative Wealth Governance Agreement (this “**Agreement**”) is made and entered into on **[Date]** (the “**Execution Date**”) by and between:

- **PARTY A:** [Party A Legal Name], an individual residing in [State] (“**Party A**”).
- **PARTY B:** [Party B Legal Name], an individual residing in [State] (“**Party B**”).
...
(c) **“Independent Administrator”** means the neutral third party who holds control authority over transfers-out, freezes, and distributions from the Vehicle Account under Exhibit 1 (whether as administrator, escrow agent, trustee, attorney-in-fact/LPOA holder, or other custodian-permitted capacity).

(d) **“Trading Authority”** means authority to place trades within the Vehicle Account, without authority to withdraw, transfer out, pledge, encumber, distribute, or otherwise move value out of the Vehicle Account.

(e) **“Custodian Constraints”** means broker/custodian rules, forms, operational limitations, regulatory requirements, settlement cycles, or legal restrictions that affect account control, freezing, liquidation, and/or distribution mechanics.

(f) **“Operative Date”** means the date the Agreement becomes operative under Section 3.2.

(g) **“Term”** means the period beginning on the Operative Date and ending on the Termination Date.
...
### 3.2 Condition Precedent; Agreement Not Operative Until Implemented
...
(b) **Party A Trading Authority.** Party A may direct trades within the Vehicle Account as Trading Authority only, subject to this Section 3.4 and Custodian Constraints.  
(c) **Guardrails (Default Prohibitions).** Unless both Parties agree otherwise in a signed writing delivered to the Independent Administrator, Party A shall not cause the Vehicle Account to:  
(i) use margin/leverage;  
(ii) engage in short selling;  
(iii) trade options, futures, swaps, or derivatives;  
...
(c) **Minimum Liquidation.** If the Vehicle Account lacks sufficient cash to pay earned fees at the time due, the Independent Administrator may liquidate the minimum amount necessary (subject to Custodian Constraints) to pay such fees and costs.
...
## ARTICLE VII — TERMINATION; LIQUIDITY EVENTS; DETERMINISTIC UNWIND
...
(b) written notice by both Parties that they have terminated this Agreement (email sufficient).
...
(ii) determine the Vehicle Account’s value as of the Valuation Time, and  
(iii) distribute the Vehicle Account within thirty (30) days (or as soon as reasonably practicable if delayed by settlement cycles, Custodian Constraints, legal restraint, or processing) as follows:

(a) **Party B’s Share (Net of Prior Distributions):**  
`max(0, (Vehicle Account value at Valuation Time × Party B’s Allocation Percentage as of the Termination Date) − (B Distribution Ledger balance as of the Termination Date))`.

(b) **Party A’s Share:**  
the remaining balance after payment of Party B’s Share and permitted deductions for unpaid fees/taxes attributable to the Vehicle Account as reflected in custodian records and/or required by Custodian Constraints.

**Death Handling:** If a Party is deceased, that Party’s share shall be distributed to that Party’s estate, trust, or designated legal recipient as directed by valid legal documentation provided to the Independent Administrator.
...
`Liquidity Settlement Amount = max(0, (Vehicle Account value at Liquidity Valuation Time × Party B’s Allocation Percentage as of the Liquidity Event Date) − (B Distribution Ledger balance as of the Liquidity Event Date))`.
...
#### 7.3.9 Optionality
Party B is not required to elect a Liquidity distribution. If Party B does not elect within the Liquidity Window, no Liquidity distribution is made for that Liquidity Event Date, and the next Liquidity Event Date occurs as scheduled.

---

## ARTICLE VIII — DISPUTE RESOLUTION (AAA; EXPEDITED; SMALL CLAIMS; EMERGENCY RELIEF; CARVE-OUTS)
...
### 8.2B AAA Rules Determination; Fallback
...
(b) confirmation, enforcement, or vacatur of an arbitration award.
...
(a) custodian reporting may be issued to the Vehicle LLC, Party A, or as otherwise required; and  
(b) distributions from the Vehicle Account may be reported in different ways depending on facts, law, and custodian practice.
...
(b) confirmations of amounts distributed and dates; and  
(c) copies of relevant custodian statements pertaining to distributions executed under this Agreement.

### 9.5 Withholding, Fees, and Transaction Costs
Custodians may impose withholding, fees, and transaction costs and may require liquidation to fund cash distributions. Any such withholding, fees, and transaction costs borne by the Vehicle Account reduce the net value available for distribution as reflected on custodian records, subject to Custodian Constraints.
...
Except for the Independent Administrator’s rights and protections expressly stated herein and in Exhibit 1, this Agreement creates no rights in any third party.
...
IN WITNESS WHEREOF, the Parties have executed this Agreement intending to be legally bound hereby.

**PARTY A:** _______________________________  Date: _______________  
**PARTY B:** _______________________________  Date: _______________

*(Notary acknowledgments recommended.)*

---

## OPTIONAL — CERTIFICATE OF INDEPENDENT LEGAL COUNSEL (ILA/ILC)

**ATTORNEY FOR PARTY A**  
I, the undersigned, am a licensed attorney in [State]. I represent Party A in connection with this Agreement. I have advised Party A regarding its legal effects, and to the best of my knowledge Party A executes voluntarily and understands its terms.  
Attorney Name / Bar #: ________________________  
Signature: _________________________________  
Date: ______________________

**ATTORNEY FOR PARTY B**  
I, the undersigned, am a licensed attorney in [State]. I represent Party B in connection with this Agreement. I have advised Party B regarding its legal effects, including the Vehicle Account governance mechanics, the allocation schedule, Liquidity Events, termination unwind, and dispute resolution. To the best of my knowledge Party B executes voluntarily and understands its terms.  
Attorney Name / Bar #: ________________________  
Signature: _________________________________  
Date: ______________________
...
## OPTIONAL — COUNSEL DECLINATION ACKNOWLEDGMENT (SUPPLEMENTAL)
...
# EXHIBIT 0 — NOTICE INFORMATION (CONTACT DETAILS FOR SECTION 2.4)

Party A Notice Email: ______________________________  
Party A Notice Address: ____________________________  
Party A Fallback Contact (optional): ________________

Party B Notice Email: ______________________________  
Party B Notice Address: ____________________________  
Party B Fallback Contact (optional): ________________

Independent Administrator Notice Email: _____________  
Independent Administrator Notice Address: ___________  
Independent Administrator Fallback Contact (optional): ________________

Acknowledged and agreed:  
Party A: ___________________________  Date: _________  
Party B: ___________________________  Date: _________  
(Optional) Independent Administrator Acknowledgment: __________________  Date: _________
...
## 1. Parties; Vehicle LLC; Account
Party A: [Name; Email; Address]  
Party B: [Name; Email; Address]  
Independent Administrator: [Name; Email; Address]  
...
Independent Administrator (Acceptance): ___________________________  Date: ___________
...
## Purpose
Confirm each Party had a fair opportunity to request/review financial information without attaching sensitive data to this Agreement.
...
Party A: ___________________________  Date: ___________  
Party B: ___________________________  Date: ___________  
(Optional) Counsel for Party A: __________________  Date: ________  
(Optional) Counsel for Party B: __________________  Date: ________
...
# EXHIBIT 5 — KEY TERMS SUMMARY (NON-BINDING; FOR CONVENIENCE ONLY)
